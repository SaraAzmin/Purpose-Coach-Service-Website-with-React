                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-5 gap-10 font-raleway">
                    <div className="shadow-lg shadow-blue-400 rounded-md md:mb-20 bg-white transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-300">
                        <div className="p-5">
                            ...
                            <a href="" className="font-bold text-blue-800 text-lg">Check Genius Blog</a>
                        </div>
                    </div>

                    <div className="shadow-lg shadow-blue-400 rounded-md bg-white md:mt-20 transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-300">
                        <div className="p-5">
                            <p className="my-3 text-gray-600">
